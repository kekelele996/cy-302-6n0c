...
- **考试记录与错题本**：查看历史记录与答题详情；客观题答错、主观题得分低于满分（含批改不完整）自动进入错题本的未掌握列表，显示题干、知识点与该场考试失分；教师改评满分或学生重新练习答对后转为已掌握并退出练习。支持按知识点复习、重复练习。
...
| PUT | `/api/v1/wrong-questions/practice/review` | 主观题练习自评（掌握/未掌握） | 学生 |
